...
function kies_treinoptie() {
    let final_datum = 'Vandaag';
    let final_vertrek = 'Amsterdam Centraal';
    let final_aankomst = 'Eindhoven Centraal';
...
current_time_vertrek.setDate(current_time_vertrek.getDate());
current_time_vertrek.setHours(current_time_vertrek.getHours() + 1); // 1 uur later
current_time_vertrek.setMinutes(current_time_vertrek.getMinutes());

let current_time_aankomst = new Date();
current_time_aankomst.setDate(current_time_vertrek.getDate());
current_time_aankomst.setHours(current_time_vertrek.getHours()); // 1 uur later
current_time_aankomst.setMinutes(current_time_vertrek.getMinutes()+80); // Aankomst is 80 minuten later
